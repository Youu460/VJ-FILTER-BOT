...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002231212148')
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'ISAGI_x3') # owner username without @
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'mcali25') # Support Chat Link Without https:// or @
...
MSG_ALRT = environ.get('MSG_ALRT', 'This deal with devil📈')
